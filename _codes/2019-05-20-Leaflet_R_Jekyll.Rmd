...
So now we have it! The only thing to remember is to reference that part to the source repository. In my case I included it on [`./_includes/leaflet.html`](../_includes/leaflet.html).
