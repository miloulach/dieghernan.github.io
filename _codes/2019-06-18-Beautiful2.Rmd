...
```{r 20190618_preparing, fig.align='center', message=FALSE, warning=FALSE, dev='svg', fig.width=700/90,fig.height=750/90,dpi=90, paged.print=FALSE, results='hide'}
...
```{r 20190618_movecan, fig.align='center', message=FALSE, warning=FALSE, dev='svg', fig.width=750/90,fig.height=550/90,dpi=90, paged.print=FALSE, tidy='styler', results='hide'}
...
```{r 20190618_Asturias, fig.align='center', message=FALSE, warning=FALSE, dev='svg', fig.width=1000/90,fig.height=(500/2)/90,dpi=90, paged.print=FALSE, tidy='styler', results='hide'}
...
- There is a small area close to the borders where the mask doesn't work. I did some tests but I was not able to fix it. Potential workaround are to use a simplified shapefile (lower level of detail) or also overlap the map increasing the width of the border (`lwd=2` in my example).
...
```{r 20190618_Andalucia, fig.align='center', message=FALSE, warning=FALSE, dev='svg', fig.width=800/(90*2),fig.height=550/(90*2),dpi=90, paged.print=FALSE, tidy='styler', results='hide'}
...
```{r 20190618_allCCAA, echo=FALSE, fig.align='center', dev='svg', fig.height=550/90, fig.width=750/90, message=FALSE, warning=FALSE, dpi=90, paged.print=FALSE, results='hide'}
par(mar=c(0,0,0,0))
plot(SPAINV2 %>% 
     st_geometry(),
     col = NA,
...
```{r 20190618_imgpost, fig.height=533/90, fig.width=800/90, dpi=90, include=FALSE}
