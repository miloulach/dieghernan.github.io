...
```{r 20190618_preparing, fig.align='center', message=FALSE, warning=FALSE, fig.width=700/90,fig.height=750/90,dpi=90, paged.print=FALSE, results='hide'}
...
```{r 20190618_allCCAA, echo=FALSE, fig.align='center', fig.height=550/90, fig.width=750/90, message=FALSE, warning=FALSE, dpi=90, paged.print=FALSE, results='hide'}
par(mar=c(0,0,0,0))
plot(SPAINV2 %>% 
     st_geometry(),
     col = NA,
