...
```{r 20190618_allCCAA, echo=FALSE, fig.align='center', fig.height=550/90, fig.width=750/90, message=FALSE, warning=FALSE, dpi=90, paged.print=FALSE, results='hide', eval=FALSE}
par(mar=c(0,0,0,0))
plot(SPAINV2 %>% 
     st_geometry(),
     col = NA,
...
```{r 20190618_imgpost, fig.height=533/90, fig.width=800/90, dpi=90, include=FALSE, dev='png', eval=FALSE}

library(jsonlite)
source("/cloud/project/assets/functions/stdh_png2map.R")
