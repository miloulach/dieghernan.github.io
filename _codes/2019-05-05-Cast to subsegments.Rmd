...
```{r 20190505_italycast, warning=FALSE, message=FALSE, tidy='styler', dev="png",fig.width=500/90, fig.height=500/90, dpi=90, fig.align='center'}
...
```{r 20190505_italycastsub,warning=FALSE, tidy='styler', echo=FALSE,dev="png",fig.width=250/90, fig.height=250/90, dpi=90, fig.align='center'}
...
```{r 20190505_testspain, warning=FALSE, message=FALSE, tidy='styler', dev="png",fig.width=500/90, fig.height=250/90, dpi=90, fig.align='center'}
...
```{r 20190505_benchmarkfunction, warning=FALSE, message=FALSE, tidy='styler', dev="png",fig.width=1000/90, fig.height=500/90, dpi=90}
...
It can be seen a noticeable difference in terms of performance, noting that `test_europe100` has `r length(st_geometry(test_europe100))` polygons decomposed in `r length(st_geometry(t1))` sub-strings while `test_europe50` has `r length(st_geometry(test_europe50))` polygons to `r length(st_geometry(t2))` sub-strings. In that sense, the original `st_cast`is much faster, although this solution may work well in most cases.
