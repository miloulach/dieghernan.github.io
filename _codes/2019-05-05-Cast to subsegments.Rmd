...
source("../functions/stdh_cast_substring.R")
...
```{r 20190505_benchmarkfunction, warning=FALSE, message=FALSE, tidy='styler', dev="png",fig.width=400/90, fig.height=500/90, dpi=90, fig.align='center'}
