...
First step is to webscrap Wikipedia in order to get the final table. For doing so, I will use the `rvest` library.
...
```{r map, message=FALSE, warning=FALSE, paged.print=FALSE, results='hide'}
library(sf)
...
```{r joining, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r missed, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```
```{r missed2, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r final, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.width=1300/90,fig.height=750/90,dpi=90}
