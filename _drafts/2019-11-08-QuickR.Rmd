...
```{r 20191108_inset, fig.align='center', message=FALSE, warning=FALSE, dpi=90, paged.print=FALSE, tidy='styler', results='hide',fig.width=900/90, fig.height=650/90}
par(mar = c(0, 0, 0, 0))
plot(
  st_geometry(world %>%
                st_transform(2163)),
