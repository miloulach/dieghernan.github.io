...
remotes::install_github("dieghernan/cartography", ref="PRlayers")
...
EUR = subset(cntries, CONTINENT.EN == "Europe")[, "SUBREGION.EN"]
...
cntries = st_read("~/R/mapslib/EUROSTAT/CNTR_RG_20M_2016_3857.geojson",
                  stringsAsFactors =FALSE)
# use newly added dataset
cntries = merge(cntries,
                df,
...
africa=subset(cntries,continentcode=="AF")
